 ...
 * <p>
 * Se verifican las operaciones principales como búsqueda,
...
public class BibliotecaTest 
{
     ...
     * post: El método retorna una lista distinta de null
     */
    @Test
    ...
    public void testBuscarPorCodigo() throws LibroNoEncontradoException
    {
        ...
        assertThrows(LibroNoEncontradoException.class, () -> {biblioteca.buscarPorCodigo("999");});
     ...
     * post: Se retorna el producto con el título exacto
     */
    @Test
    public void testBusquedaBinariaPorTitulo() throws LibroNoEncontradoException
    {
        ...
        assertThrows(LibroNoEncontradoException.class, () -> {biblioteca.busquedaBinariaPorTitulo("Libro z");});
    }
     ...
     * post: 
     *  - Si encuentra, la lista no es null
     *  - Si no encuentra, la lista está vacía
     */
    @Test
     ...
     * post: La lista retornada no es null
     */
    @Test
     ...
     * post: 
     *  - Si hay productos con descuento, la lista no es null
     *  - Si no hay productos con descuento, la lista está vacía
     */
    @Test
